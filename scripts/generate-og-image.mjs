...
try {
  ...
  </style><main><div class="brand"><img src="data:image/svg+xml;base64,${logo}" alt="">Alberta Birth KO</div><h1>알버타 출생증명서<br>한글 번역문 생성</h1><p>한글 입력부터 Letter PDF 저장까지</p><div class="pill">브라우저에서 간편하게 작성하세요</div><div class="doc"><strong>출생증명서</strong><div class="rule"></div><span>한글 번역문</span><div class="rule"></div><b>PDF</b><small>Letter · 8.5 × 11 in</small></div><div class="url">ab-birthcert-ko.mydy.kr · 비공식 번역문 작성 도구</div></main></html>`);
