...
try {
  ...
  </style><main><div class="brand"><img src="data:image/svg+xml;base64,${logo}" alt="">Translate Alberta Birth Certificate to Korean</div><h1>알버타 출생증명서<br>한글 번역문 생성</h1><p>주밴쿠버 대한민국 총영사관 제출을 위한<br>출생증명서 한글 번역문을 만들어 드립니다.</p><div class="pill">브라우저에서 간편하게 작성하세요</div><div class="doc"><strong>출생증명서</strong><div class="rule"></div><span>한글 번역문</span><div class="rule"></div><b>PDF</b></div><div class="url">ab-birthcert-ko.mydy.kr</div></main></html>`);
