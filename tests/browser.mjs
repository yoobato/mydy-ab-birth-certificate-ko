...
await page.locator('#sex').selectOption('F');assert.equal(await page.locator('#registrarKo').inputValue(),'트레버 버겐');assert.equal(await page.locator('#count').innerText(),'14 / 14');
