...
await page.locator('#sex').selectOption('F');await page.locator('#confirmed').check();assert.equal(await page.locator('#registrarKo').inputValue(),'트레버 버겐');assert.equal(await page.evaluate(()=>window.registeredTool.execute({}).completed),15);
